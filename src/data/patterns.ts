...
export const patterns: Pattern[] = [
  {
        ...
        for i in range(len(nums) - 2):
            ...
            while left < right:
                ...
                if total == 0:
                    ...
                    right -= 1
        return result`,
        companies: ['Facebook', 'Amazon', 'Google', 'Microsoft', 'Adobe']
      },
      {
        id: 'tp-3',
    ...
    def isPalindrome(self, s: str) -> bool:
        ...
        while left < right:
            ...
            right -= 1
        return True`,
        companies: ['Facebook', 'Apple', 'Microsoft', 'Amazon', 'Google']
      },
      {
        id: 'tp-5',
    ...
    def validPalindrome(self, s: str) -> bool:
        ...
        while left < right:
            ...
            right -= 1
        return True`,
        companies: ['Facebook', 'Amazon', 'Google', 'Microsoft', 'Twitter']
      },
      {
        id: 'tp-17',
    ...
    def intervalIntersection(self, firstList: List[List[int]], secondList: List[List[int]]) -> List[List[int]]:
        ...
        while left < len(firstList) and right < len(secondList):
            ...
            if firstList[left][1] < secondList[right][1]:
                ...
                right += 1
        return result`,
        companies: ['Facebook', 'Google', 'Amazon', 'Bloomberg', 'Airbnb']
      },
      {
        id: 'tp-43',
    ...
    def flipAndInvertImage(self, image: List[List[int]]) -> List[List[int]]:
        for row in image:
            ...
            while left <= right:
                ...
                right -= 1
        return image`,
        companies: ['Amazon', 'Google', 'Apple', 'Facebook', 'Twitter']
      },
      {
        id: 'tp-61',
    ...
    def minMeetingRooms(self, intervals: List[List[int]]) -> int:
        ...
        return result`,
        companies: ['Facebook', 'Amazon', 'Google', 'Microsoft', 'Airbnb']
      },
      {
        id: 'tp-71',
        title: 'Car Fleet',
    ...
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
      ...
      {
        id: 'tp-72',
        title: 'Maximum Number of Visible People in a Queue',
        difficulty: 'Hard',
        leetcodeUrl: 'https://leetcode.com/problems/number-of-visible-people-in-a-queue/',
        description: 'Given an array heights of distinct integers representing people standing in a queue, return an array where answer[i] is the number of people the ith person can see to their right.',
        language: 'python',
        solution: `class Solution:
        ...
        for i in range(len(s)):
            for odd, even in [(i, i), (i, i + 1)]:
                ...
                while l >= 0 and r < len(s) and s[l] == s[r]:
                    ...
                    r += 1
        return result`,
        companies: ['Amazon', 'Google', 'Adobe', 'Facebook', 'Bloomberg']
      },
      {
        id: 'sw-60',
    ...
    def longestAlternatingSubarray(self, nums: List[int], threshold: int) -> int:
        ...
        while i < len(nums):
            if nums[i] % 2 == 0 and nums[i] <= threshold:
                ...
                i += 1
        return result`,
        companies: ['Amazon', 'Google', 'Facebook', 'Samsung', 'Microsoft']
      },
      {
        id: 'sw-92',
  ...
  },
  {
    ...
    def amountPainted(self, paint: List[List[int]]) -> List[int]:
      ...
      },
      {
        ...
        difficulty: 'Medium',
        leetcodeUrl: 'https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/',
        description: 'Given an array of integers nums and an integer limit, return the size of the longest subarray such that the absolute difference between any two elements is less than or equal to limit.',
        language: 'python',
        solution: `class Solution:
    def longestSubarray(self, nums: List[int], limit: int) -> int:
        from collections import deque
...
},
{
    ...
    def fullBloomFlowers(self, flowers: List[List[int]], people: List[int]) -> List[int]:
      ...
      {
        id: 'mi-56',
        title: 'Minimum Interval to Include Each Query II',
        difficulty: 'Hard',
        leetcodeUrl: 'https://leetcode.com/problems/minimum-interval-to-include-each-query/',
        description: 'Given intervals and queries, for each query find the size of the smallest interval containing the query point. Use offline processing with sorting for optimal performance.',
        language: 'python',
        solution: `class Solution:
    def minInterval(self, intervals: List[List[int]], queries: List[int]) -> List[int]:
        import heapq
      ...
      },
      {
        ...
        description: 'Given a sorted unique integer array nums, return the smallest sorted list of ranges that cover all the numbers in the array exactly.',
        language: 'python',
        solution: `class Solution:
